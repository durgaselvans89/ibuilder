...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'user_dirs' => false,
            'mkdir_mode' => 0777, //0755, //0777, works 
            'param_name' => 'files',
    ...
    protected function upcount_name_callback($matches) {
        ...
        // rename file is if is already uploaded
		// OLD return '('.$index.')'.$ext;
		return '_'.$index.''.$ext;
    }
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
                    ...
                    move_uploaded_file($uploaded_file, $file_path); chmod($file_path, 0777);
                }
            } else {
