...
<div class="tabs">
    ...
    <div class="zip_form" id="zip_this">DOWNLOAD<form id="zip_form" action="php/cogneroPackager.php" method="post"><input id="iteration" type="text" name="iteration" value="" hidden></input></form></div>
    <div class="zip_form" id="zip_all">DOWNLOAD ALL<form id="zip_form_all" action="php/packageAll.php" method="post"></form></div>
...
<script type="text/javascript" charset="utf-8">
	...
	var coordinate_object_array = [];
	var coordinate_object_array1 = [];
	var coordinate_object_values = [];
	var coordinate_object_values1 = [];
...
//                    url: media_path + entryPoint,
        ...
        defineTypes: function( template ) {
            ...
            console_on && console.log('defineTypes');
                        
            // Define Defults
            default_build = ['title', 'content_box', 'answer' ]; //'question', 'answer', 'help', 'solution', 'feedback', 'parameter', 'media'
            default_values = '{"id": "0", "type": "txt","correct":"","name": "", "text": "", "top": "default", "left": "default", "width": "default"}';
            new_values = '{"id": "0"}';
            ...
            type_object_values = ['text', 'size', 'aid', 'source', 'output', 'has_border']; 
            select_object_values = ['text','correct', 'size', 'aid', 'width', 'has_border']; 
            ...
            case 'ps03': // Type Entry
              template_name = 'Type Entry';
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box','type_object','select_object'];
              break;              
          ...
          case 'ps08': // Coordinate Plane Graphing Simple
		  	template_name = 'Coordinate Plane Graphing Simple';
		    formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'coordinate_object', 'content_box'];
            coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope', 'colorMode'];
 
			break;

          case 'ps09': // Complex Coordinate Plane Graphing
            template_name = 'Complex Coordinate Plane Graphing';
            formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'coordinate_object', 'content_box'];
            coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'colorMode', 'lineOption', 'shadeOption', 'arrowOption', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y',
                'show_scale', 'slope', 'inequalities', 'no_solution']; 

            break;

		  case 'ps10': // Grid Paper Graphing
		  	template_name = 'Grid Paper Graphing';
		    formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'coordinate_object', 'content_box'];
            coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'scale', 'sides', 'points', 'sideLengths', 'area',
                'perimeter', 'square', 'rectangle', 'triangle'];
			break;

          case 'ps11': // Drag and Drop Coordinate Plane
            template_name = 'Drag and Drop Coordinate Plane';
            formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'coordinate_object', 'content_box'];
            coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'equation_type',
                'rotation_point', 'ghosted', 'a', 'b', 'c', 'reference_labels', 'connect', 'label_x', 'label_y', 'scale_x', 'scale_y'];
            break;
			 case 'ps20':
              template_name = 'Multi-Choice';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer','single'];
              answer_values = ['correct','aid'];          
            break;            
          case 'ps22':
              template_name = 'Multi-Choice and Multi-Choice';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'content_box1','marker','marker1','answer','answer1'];
              answer_values = ['correct','aid'];          
            break;
			 /*case 'ps23':
              template_name = 'Multi-Choice and Drag and Drop';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer'];
              answer_values = ['correct','aid'];          
            break;*/ //ps24
			case 'ps24':
              template_name = 'Multi-Choice and Type Entry';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer','type_object','select_object'];
              answer_values = ['correct','aid'];       
            break;
			case 'ps25':
              template_name = 'Multi-Choice and Coordinate Plane Graphing Simple';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer', 'coordinate_object'];
			   coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope', 'colorMode'];
              answer_values = ['correct','aid'];       
            break;
			case 'ps26':
              template_name = 'Multi-Choice and Coordinate Plane Graphing Complex';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer', 'coordinate_object'];
              answer_values = ['correct','aid']; 
			  coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'colorMode', 'lineOption', 'shadeOption', 'arrowOption', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y',
            ...
            break;		
			case 'ps27':
              template_name = 'Multi-Choice and Number Line';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer', 'numberline_object'];
              answer_values = ['correct','aid']; 
			  coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'colorMode', 'lineOption', 'shadeOption', 'arrowOption', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y',
                'show_scale', 'slope', 'inequalities', 'no_solution'];       
            ...
            break;	
			case 'ps29':
              template_name = 'Multi-Choice and Square Shading';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer', 'shading_object', 'image_object'];
              answer_values = ['correct','aid']; 
              shading_object_values = ['rows','rows_x','columns','columns_x','border_style', 'show_labels', 'label_start_at', 'red_check','red_value','red_array','blue_check','blue_value','blue_array','green_check','green_value','green_array','yellow_check','yellow_value','yellow_array','multiple_cell']; 
            break;	
			 case 'ps210':
              template_name = 'Multi-Choice and Grid Paper Graphing';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'marker','answer', 'coordinate_object'];
			  coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'scale', 'sides', 'points', 'sideLengths', 'area',
                'perimeter', 'square', 'rectangle', 'triangle'];
              answer_values = ['correct','aid']; 
            break;		
		 case 'ps32':
              template_name = 'Drag-N-Drop and Multi-Choice';              
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box','content_box1', 'marker','answer','dragndrop_setup', 'drop_object', 'drag_object', 'image_object'];
			  dragndrop_setup_values = ['type', 'unique', 'restrict'];
              drop_object_values = ['width', 'height', 'border_style', 'drag_array', 'value']; 
              drag_object_values = ['count', 'value']; 
              answer_values = ['correct','aid'];          
            break;
			  ...
			  //Drag and Drop and Type Entry
			 case 'ps34':
               template_name = 'Drag -N- Drop and Type Entry';
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'dragndrop_setup', 'drop_object', 'drag_object', 'image_object','type_object','select_object'];
              dragndrop_setup_values = ['type', 'unique', 'restrict'];
              drop_object_values = ['width', 'height', 'border_style', 'drag_array', 'value']; 
              drag_object_values = ['count', 'value'];         
            break;
			//Drag and Drop CPlane Graphing Simple
			case 'ps35':
               template_name = 'Drag and Drop CPlane Graphing Simple';
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'dragndrop_setup', 'drop_object', 'drag_object', 'image_object', 'coordinate_object'];
              dragndrop_setup_values = ['type', 'unique', 'restrict'];
              drop_object_values = ['width', 'height', 'border_style', 'drag_array', 'value']; 
              drag_object_values = ['count', 'value']; 
			   coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope', 'colorMode'];        
            break;
			//Drag and Drop--Number Line
			case 'ps37':
               template_name = 'Drag -N- Drop and Number Line';
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'dragndrop_setup', 'drop_object', 'drag_object', 'image_object', 'numberline_object'];
              dragndrop_setup_values = ['type', 'unique', 'restrict'];
              drop_object_values = ['width', 'height', 'border_style', 'drag_array', 'value']; 
              drag_object_values = ['count', 'value'];   
			   numberline_object_values =  JSONObject.numberline_object != undefined ? JSONObject.numberline_object[0] : {
            ...
            break;
			case 'ps47': // Type Entry and number line
              template_name = 'Type Entry and Number Line';
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box','type_object','select_object', 'numberline_object'];
              numberline_object_values =  JSONObject.numberline_object != undefined ? JSONObject.numberline_object[0] : {
                  "lineColor": "#000",
                  "hlColor":"#ff0000",
                  "lineLength": 450,
              ...
              break;
                case 'ps54':
              template_name = 'Coordinate Plane Graphing and Type Entry';               
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'coordinate_object', 'content_box','content_box1','type_object','select_object'];
              coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
            break;
			case 'ps55':
            	template_name = 'Coordinate Plane Graphing and Coordinate Plane Graphing';               
              	formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'coordinate_object','coordinate_object1', 'content_box'];
				coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open'					                ,'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
				coordinate_object_values1 = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open'					                ,'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
				
            break;
			case 'ps57':
              	template_name = 'Coordinate Plane Graphing and Number Line';               
             	formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'coordinate_object','numberline_object'];
             	numberline_object_values =  JSONObject.numberline_object != undefined ? JSONObject.numberline_object[0] : {
                  "lineColor": "#000",
                  "hlColor":"#ff0000",
                  "lineLength": 450,
				...
				coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 
				'object_data_open','connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
            break;	
        	 case 'ps58':
              template_name = 'Coordinate Plane Graphing and Highlighting';               
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box','coordinate_object','highlight_object'];
              coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
				highlight_object_values = ['text','correct','aid']; 
            ...
            break;
			 case 'ps59':
              template_name = 'Coordinate Plane Graphing and Square Shading';               
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box','coordinate_object','shading_object'];
              coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
			shading_object_values = ['rows','rows_x','columns','columns_x','border_style', 'show_labels', 'label_start_at', 'red_check','red_value','red_array','blue_check','blue_value','blue_array','green_check','green_value','green_array','yellow_check','yellow_value','yellow_array','multiple_cell']; 
            break;
			 case 'ps510':
              template_name = 'Coordinate Plane Graphing and Grid Paper Graphing';               
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box', 'coordinate_object', 'coordinate_object1'];
              coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
			  coordinate_object_values1 = ['coordinate_object_answer', 'coordinate_object_data', 'scale', 'sides', 'points', 'sideLengths', 'area','perimeter', 'square', 'rectangle', 'triangle'];
			
            break;
			case 'ps56':
              template_name = 'Coordinate Plane Graphing and Complex Coordinate Plane Graphing';               
              formSetup = ['template', 'iteration', 'layout', 'grades', 'title', 'content_box','coordinate_object',  'coordinate_object1'];
              coordinate_object_values = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y', 'show_scale', 'slope'];
			  coordinate_object_values1 = ['coordinate_object_answer', 'coordinate_object_data', 'coordinate_object_type', 'object_data_open',
                'connect', 'colorMode', 'lineOption', 'shadeOption', 'arrowOption', 'label_x', 'label_y', 'quadrants', 'scale_x', 'scale_y',
                'show_scale', 'slope', 'inequalities', 'no_solution']; 
            break;
        ...
        change_font_size: function( event ) {
            ...
            console_on && console.log('change_font_size');
        ...
        change_mode: function( event ) {
            ...
            console_on && console.log('change_mode');
        ...
        change_snap_to: function( event ) {
            ...
            console_on && console.log('change_snap_to');
        ...
        setupLayout: function( event ) {
            ...
            console_on && console.log('setupLayout');
        ...
        revertLayout: function( event ) {
            ...
            console_on && console.log('revertLayout');
            ...
            if ( typeof JSONObject.answer1 !== 'undefined' ) {
                $.each( JSONObject.answer1, function( index, value ) { 
                    JSONObject.answer1[index].top = 'default';
                    JSONObject.answer1[index].left = 'default';
                });
            }
        ...
        hideLayout: function( event ) { 
            ...
            console_on && console.log('hideLayout');
        ...
        showLayout: function( event ) {
            ...
            console_on && console.log('showLayout');
        ...
        changeLayout: function( event ) {
            ...
            console_on && console.log('changeLayout');
        ...
        changeMarker: function( event ) {
            ...
            console_on && console.log('changeMarker');
        ...
        assignJson: function( data ) {
            ...
            console_on && console.log('assignJson');
            ...
            if ( typeof JSONObject.coordinate_object !== 'undefined' ) {
                $.each( JSONObject.coordinate_object, function( index, value ) { 
                    coordinate_object_array.push(value);
                });
            }
			if ( typeof JSONObject.coordinate_object1 !== 'undefined' ) {
                $.each( JSONObject.coordinate_object1, function( index, value ) { 
                    coordinate_object_array1.push(value);
                });
            }
        ...
        select_type : function( event ) { 
            ...
            console_on && console.log('select_type');
        ...
        feedback_type : function( event ) { 
            ...
            console_on && console.log('feedback_type');
        ...
        presets: function( event ) {
            ...
            console_on && console.log('presets');
			...
			if ( typeof JSONObject.single !== 'undefined' ) {
                JSONObject.single = false;
            }           
...
// pageBuilder : builds html on the page from JSON cotnent - this will also be used in template player                  
        ...
        buildJSON: function( block_type, block_id ) {           
            ...
            console_on && console.log('buildJSON '+block_type);
            ...
            case 'title': 
                ...
                title_array.push(JSON.parse(default_values));
            ...
            case 'content_box': 
                ...
                content_box_array.push(JSON.parse(default_values));               
                LO_page_app.setid( block_type, block_id );
                break;
            case 'content_box1': 
                //               
                JSONObject[block_type] = content_box_array1;
                content_box_array1.push(JSON.parse(default_values));               
                LO_page_app.setid( block_type, block_id );
                break;
            case 'tooltip': 
                //
                JSONObject[block_type] = tooltip_array;
                tooltip_array.push(JSON.parse(default_values));
            ...
            case 'cover': 
                ...
                cover_array.push(JSON.parse(default_values));
            ...
            case 'move_object': 
                ...
                move_object_array.push(JSON.parse(default_values));
            ...
            case 'drop_object': 
                ...
                drop_object_array.push(JSON.parse(default_values));
            ...
            case 'drag_object': 
                ...
                drag_object_array.push(JSON.parse(default_values));
            ...
            case 'question': 
                ...
                question_array.push(JSON.parse(default_values));
            ...
            case 'answer': 
                ...
                answer_array.push(JSON.parse(default_values));   
            ...
            case 'answer1': 
                //
                JSONObject[block_type] = answer_array1;
                answer_array1.push(JSON.parse(default_values));   
            ...
            case 'image_object': 
                ...
                image_object_array.push(JSON.parse(default_values)); 
            ...
            case 'shading_object': 
                ...
                shading_object_array.push(JSON.parse(default_values));   
            ...
            case 'numberline_object':
                ...
                numberline_object_array.push(JSON.parse(default_values));
                ...
                JSONObject[block_type][block_id]["top"] = 180;
                JSONObject[block_type][block_id]["left"] = 100;
            ...
            case 'coordinate_object': 
                //
                JSONObject[block_type] = coordinate_object_array;
                coordinate_object_array.push(JSON.parse(default_values));   

                //add custome shading_object values 
                $.each( coordinate_object_values, function( index, value ) { 
                    if ( typeof JSONObject[block_type][block_id] !== 'undefined' ) {    
                        JSONObject[block_type][block_id][value] = "";
                    }
                });
                ...
                break;
			case 'coordinate_object1': 
                //
                JSONObject[block_type] = coordinate_object_array1;
                coordinate_object_array1.push(JSON.parse(default_values));   

                //add custome shading_object values 
                $.each( coordinate_object_values1, function( index, value ) { 
                    if ( typeof JSONObject[block_type][block_id] !== 'undefined' ) {    
                        JSONObject[block_type][block_id][value] = "";
                    }
                });
            ...
            case 'hint': 
                ...
                hint_array.push(JSON.parse(default_values));
            ...
            case 'directions': 
                ...
                directions_array.push(JSON.parse(default_values));
            ...
            case 'play_button': 
                ...
                play_button_array.push(JSON.parse(default_values));
        ...
        destroyJSON: function( block_type, block_id ) {
            ...
            console_on && console.log('destroyJSON');
        ...
        formBuilder: function( event ) {
            ...
            console_on && console.log('formBuilder');
            ...
            if (template_name == "Type Entry") {
                JSONObject.use_keypad = JSONObject.use_keypad || "true";
                JSONObject.shadows = JSONObject.shadows || "true";
                formArr += '<div><br>'; 
                formArr += '<input type="checkbox" data-type="use_keypad"  value="'+(JSONObject.use_keypad)+"\""+(JSONObject.use_keypad == "true"?"checked":"")+'> &nbsp; Use Keypads</input>';
                formArr += '&nbsp;&nbsp;<span class="small">( toggling this will clear all type object answer values )</span></div>';
                formArr += '<div><br>'; 
                formArr += '<input type="checkbox" value="'+(JSONObject.shadows)+'"'+(JSONObject.shadows == "true"?" checked ":"")+/*(JSONObject.use_keypad != "true" ? " disabled ":"" )+*/'data-type="shadows" > Shadows</div>';
            }          
            // Content Box Data 
            ...
            // Content Box 1 Block
            if(JSONObject.content_box1 !=undefined){
                contentBoxArr += '<!-- Content Box Block -->';
                contentBoxArr +=  '<div id="content_box1" class="block">';

                contentBoxArr +=      '<strong>Content Box:</strong>';
                if (template_name == "Type Entry") {
                    JSONObject.use_keypad = JSONObject.use_keypad || "true";
                    JSONObject.shadows = JSONObject.shadows || "true";
                    contentBoxArr += '<div><br>'; 
                    contentBoxArr += '<input type="checkbox" data-type="use_keypad"  value="'+(JSONObject.use_keypad)+"\""+(JSONObject.use_keypad == "true"?"checked":"")+'> &nbsp; Use Keypads</input>';
                    contentBoxArr += '&nbsp;&nbsp;<span class="small">( toggling this will clear all type object answer values )</span></div>';
                    contentBoxArr += '<div><br>'; 
                    contentBoxArr += '<input type="checkbox" value="'+(JSONObject.shadows)+'"'+(JSONObject.shadows == "true"?" checked ":"")+/*(JSONObject.use_keypad != "true" ? " disabled ":"" )+*/'data-type="shadows" > Shadows</div>';
                }           
                // Content Box Data 
                $.each(JSONObject.content_box1, function(index) { 
                    ...
                    contentBoxArr +=  '<div class="in_block" data-name="content_box1" data-id="'+index+'">';
                    
                    if ( index > 0 ) {
                    contentBoxArr +=  '   <div class="remove">[ - ]</div>';
                    }
                    
                    contentBoxArr +=  '<div style="display: inline;">'+$.content_box_marker+'.</div> ';
                    contentBoxArr +=      '<select name="content_box_type " class="select_type" data-type="select" data-json-name="type">';
                    if ( $.content_box_type == 'txt') { contentBoxArr += '<option value="txt" selected>text</option>'; } else { contentBoxArr += '<option value="txt">text</option>'; }
                    if ( $.content_box_type == 'img') { contentBoxArr += '<option value="img" selected>image</option>'; } else { contentBoxArr += '<option value="img">image</option>'; }
                    if ( $.content_box_type == 'hide') { contentBoxArr += '<option value="hide" selected>hide</option>'; } else { contentBoxArr += '<option value="hide">hide</option>'; }
                    contentBoxArr +=      '</select>';
                    
                    contentBoxArr +=  '&nbsp;&nbsp; Width: <input type="text" name="width" class="width" data-type="text" data-json-name="width" value="'+$.content_box_width+'" size="2"> <span class="small">( accepts numeric width or keyword <strong>default</strong> )</span>';
                    
                    contentBoxArr +=  '<div class="block_hide '+block_hide+'" style="color: #ccc; float: right; margin-right: 300px;">THIS BLOCK IS HIDDEN</div>';

                    contentBoxArr +=  '<div class="block_show '+block_show+'">';

                    contentBoxArr +=  '<div class="form_image '+form_image+'">';
                    contentBoxArr +=  '<div class="select_images">';
                    contentBoxArr +=      '<div class="progress"><div class="bar" style="width: 0%;"></div></div>';
                    contentBoxArr +=      '<span class="button">Choose File</span>';
                    contentBoxArr +=      '<span class="val">'+$.content_box_name+'</span>';
                    contentBoxArr +=  '</div><br>';
                    contentBoxArr +=  'Image Description (not visible on the page)<br>';
                    contentBoxArr +=  '</div>';

                    contentBoxArr += '<textarea rows="2" cols="55" name="content_box" class="text" data-type="textarea" data-json-name="text">';
                    contentBoxArr += $.content_box_text;
                    contentBoxArr += '</textarea><br>';

                    contentBoxArr += '</div>';
                    contentBoxArr += '</div>';                
                });
                
                contentBoxArr += '<div class="in_block add_block">';
                contentBoxArr += '    <div class="add">Add [ + ]</div>';
                contentBoxArr += '</div>';
                
                contentBoxArr += '<span class="small tips">tips</span>';
                
                contentBoxArr +=  '</div>';
                contentBoxArr +=  '<!-- END Content Box Block -->';   
            }                    
            // END Content Box 1 Block
            // Move Object Block
            if ( typeof JSONObject.move_object !== 'undefined' ) {
            ...
            if ( typeof JSONObject.marker !== 'undefined' ) {
				...
				if(JSONObject.single == true){
					formArr +=  '<input type="checkbox" data-name="single" class="correct" value="false" data-type="checkbox" data-json-name="single" checked> <span class="small note">check if single answer</span>';				
				}else{
					formArr +=  '<input type="checkbox" data-name="single" class="correct" value="false" data-type="checkbox" data-json-name="single"> <span class="small note">check if single answer</span>';				
				}
            ...
            formArr += '<!-- Answer Block -->';
            formArr +=  '<div id="answer1" class="block">';
            ...
            $.each(JSONObject.answer1, function(index) { 
                ...
                formArr +=  '<div class="in_block" data-name="answer1" data-id="'+index+'">';
            ...
            $.each(JSONObject.type_object, function(index) { 
                ...
                this.has_border = this.has_border || "true";
                ...
                if ( $.type_object_type == '4') { formArr += '<option value="4" selected>Keypad 4 (ela)</option>'; }  else { formArr += '<option value="4">Keypad 4 (ela)</option>'; }
                formArr +=      '</select>';
                ...
                if ( typeof this.has_border !== 'undefined' ) {
                    if ( this.has_border == 'true' ) {
                        formArr +=  '&nbsp;&nbsp;Borders: <input type="checkbox" name="has_border" class="has_border" value="true" data-type="checkbox" data-json-name="has_border" checked>';
                    } else {
                        formArr +=  '&nbsp;&nbsp;Borders: <input type="checkbox" name="has_border" class="has_border" value="false" data-type="checkbox" data-json-name="has_border">';
                    }
                }
                
                formArr +=  '<div class="block_show '+block_show+'">';
                
                formArr += '<span class="keypad_label">Content</span>';
                if (typeof JSONObject.use_keypad != "undefined" && JSONObject.use_keypad == "false") {
                    formArr +=  '<br><br>&nbsp;&nbsp; <input type="text" id="type_object_content_'+$.type_object_id+'" class="type_object_form" data-type="text" data-json-name="source" value="'+$.type_object_output+'">';
                } else {
                    formArr += '<br>&nbsp;&nbsp;<div id="type_object_form_'+ $.type_object_id +'" data-id="'+ $.type_object_id +'" class="type_object keypad_box" data-htmlarray=\'[' + $.type_object_source + ']\' data-output="' + $.type_object_output + '" data-charlimit="'+$.type_object_size+'" data-keypad="'+$.type_object_type+'">'+$.type_object_output+'</div><br>';
                }
            ...
            $.each(JSONObject.select_object, function(index) { 
                ...
                formArr +=  '&nbsp;&nbsp; Width: <input type="text" name="width" class="width" data-type="text" data-json-name="width" value="'+this.width+'" size="2"> <span class="small">( numeric / <strong>default</strong> )</span>';
            ...
            if ( typeof JSONObject.numberline_object !== 'undefined' ) {
                ...
                $.each(JSONObject.numberline_object, function(index) { 
                    ...
                    //Option to select starting end points (apparently not needed)
                    //var list_marks = "arrow,tick,circle-open,circle-filled".split(",");
            ...
            // Coordinate Object Block
            if ( typeof JSONObject.coordinate_object !== 'undefined' ) {
                
                formArr += '<!-- Coordinate Object Block -->';
                formArr +=  '<div id="coordinate_object" class="block">';

                formArr +=      '<strong>Coordinate Object:</strong>';
                ...
                $.each(JSONObject.coordinate_object, function(index) { 
                    ...
                    // all
                    $.coordinate_object_answer = this.coordinate_object_answer;
                    $.coordinate_object_data = this.coordinate_object_data;

                    // 08, 09, and 11
                    $.coordinate_object_type = this.coordinate_object_type;
                    $.coordinate_object_label_x = this.label_x;
                    $.coordinate_object_label_y = this.label_y;
                    $.coordinate_object_scale_x = this.scale_x;
                    $.coordinate_object_scale_y = this.scale_y;

                    // 08 and 09
                    $.coordinate_object_quadrants = this.quadrants;
                    $.coordinate_object_show_scale = this.show_scale;
                    $.coordinate_object_connect = this.connect;
                    $.coordinate_object_open = this.object_data_open;
                    $.coordinate_object_slope = this.slope;
                    $.coordinate_object_color_mode = this.colorMode;

                    // ps09
                    $.coordinate_object_line_option = this.lineOption;
                    $.coordinate_object_shade_option = this.shadeOption;
                    $.coordinate_object_arrow_option = this.arrowOption;
                    $.coordinate_object_inequalities = this.inequalities;
                    $.coordinate_object_show_origin = this.show_origin;
                    $.coordinate_object_no_solution = this.no_solution;

                    // ps10
                    $.coordinate_object_scale = this.scale;
                    $.coordinate_object_sides = this.sides;
                    $.coordinate_object_side_lengths = this.sideLengths;
                    $.coordinate_object_points = this.points;
                    $.coordinate_object_area = this.area;
                    $.coordinate_object_perimeter = this.perimeter;
                    $.coordinate_object_square = this.square;
                    $.coordinate_object_rectangle = this.rectangle;
                    $.coordinate_object_triangle = this.triangle;

                    // ps11
                    $.coordinate_object_equation_type = this.equation_type;
                    $.coordinate_object_ghosted = this.ghosted;
                    $.coordinate_object_reference_labels = this.reference_labels;
                    $.coordinate_object_rotation_point = this.rotation_point;
                    $.coordinate_object_a = this.a;
                    $.coordinate_object_b = this.b;
                    $.coordinate_object_c = this.c;
                    $.coordinate_object_show_flip_horz_btn = this.show_flip_horz_btn;
                    $.coordinate_object_show_flip_vert_btn = this.show_flip_vert_btn;
                    $.coordinate_object_show_rotate_btn = this.show_rotate_btn;
								
	                formArr +=  '<div class="in_block" data-name="coordinate_object" data-id="'+index+'">';
                	
                    // number of quadrants
					if(JSONObject.template === "ps08" || JSONObject.template === "ps09" || JSONObject.template === "ps54" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26" || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59" || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        if ($.coordinate_object_quadrants == undefined ) $.coordinate_object_quadrants = '1';
    	                formArr +=   'Quadrants <select name="quadrants" class="quadrants" data-type="select" data-json-name="quadrants">';
    	                if ( $.coordinate_object_quadrants == '1') { formArr += '<option value="1" selected>1</option>'; } else { formArr += '<option value="1">1</option>'; }
    	                if ( $.coordinate_object_quadrants == '4') { formArr += '<option value="4" selected>4</option>'; } else { formArr += '<option value="4">4</option>'; }
    	                formArr +=      '</select>';
    		            formArr +=      '<br>';
					}

                    // scales
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps11" || JSONObject.template == "ps09" || JSONObject.template === "ps54" ||  JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26" || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59" || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        if ($.coordinate_object_scale_x == undefined) $.coordinate_object_scale_x = "";
                        if ($.coordinate_object_scale_y == undefined) $.coordinate_object_scale_y = "";
    	                formArr +=  'Grid Scale X <input type="text" name="grid_scale_x" class="grid_scale_x" data-type="text" data-json-name="scale_x" value="'+$.coordinate_object_scale_x+'" size="1">&nbsp;&nbsp;&nbsp;&nbsp;';
                        formArr +=  'Grid Scale Y <input type="text" name="grid_scale_y" class="grid_scale_y" data-type="text" data-json-name="scale_y" value="'+$.coordinate_object_scale_y+'" size="1">&nbsp;&nbsp;&nbsp;&nbsp;';
                    }
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if ($.coordinate_object_scale == undefined) $.coordinate_object_scale = "";
                        formArr +=  'Scale <input type="text" name="scale" class="scale" data-type="text" data-json-name="scale" value="'+$.coordinate_object_scale+'" size="1">';
                    }
            
                    // show scales
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps09" || JSONObject.template === "ps54" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26" || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59" || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        if ($.coordinate_object_show_scale == undefined) $.coordinate_object_show_scale = 'true';
                        if ($.coordinate_object_show_scale == 'true') {
                            formArr +=  '<input type="checkbox" name="show_scale" class="show_scale" value="true" data-type="checkbox" data-json-name="show_scale" checked> Display Grid Scale';
                        } else {
                            formArr +=  '<input type="checkbox" name="show_scale" class="show_scale" value="false" data-type="checkbox" data-json-name="show_scale"> Display Grid Scale';
                        }
                    }
                    formArr += "<br>";
                    ...
                    // labels
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps11" || JSONObject.template == "ps09" || JSONObject.template == "ps54" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26"  || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59" || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        if ($.coordinate_object_label_x == undefined) $.coordinate_object_label_x = "";
                        if ($.coordinate_object_label_y == undefined) $.coordinate_object_label_y = "";
                        formArr +=  'Grid Label X <input type="text" name="grid_scale" class="grid_scale" data-type="text" data-json-name="label_x" value="'+$.coordinate_object_label_x+'" size="1">';
                        formArr +=  '&nbsp;&nbsp;&nbsp;&nbsp;Grid Label Y <input type="text" name="grid_scale" class="grid_scale" data-type="text" data-json-name="label_y" value="'+$.coordinate_object_label_y+'" size="1">&nbsp;&nbsp;&nbsp;&nbsp;';
                    }
            
                    // show origin
                    if(JSONObject.template === "ps09" || JSONObject.template === "ps26") {
                        if ($.coordinate_object_show_origin == undefined) $.coordinate_object_show_origin = 'true';
                        if ($.coordinate_object_show_origin == 'true') {
                            formArr +=  '<input type="checkbox" name="show_origin" class="show_origin" value="true" data-type="checkbox" data-json-name="show_origin" checked> Display Origin';
                        } else {
                            formArr +=  '<input type="checkbox" name="show_origin" class="show_origin" value="false" data-type="checkbox" data-json-name="show_origin"> Display Origin';
                        }
                    }
                    formArr += "<br>";
					...
					// sides
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_sides == undefined) $.coordinate_object_sides = "";
						formArr +=  'Side Count <input type="text" name="sides" class="sides" data-type="text" data-json-name="sides" value="'+$.coordinate_object_sides+'" size="1">';
						formArr += "<br>";
					}

                    // side lengths
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_side_lengths == undefined) $.coordinate_object_side_lengths = "";
                        formArr +=  'Side Lengths <input type="text" name="sideLengths" class="" data-type="text" data-json-name="sideLengths" value="'+$.coordinate_object_side_lengths+'" size="30"><br>';
                    }
					
                    // points
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_points == undefined) $.coordinate_object_points = "";
                        formArr +=  'Point Count <input type="text" name="points" class="points" data-type="text" data-json-name="points" value="'+$.coordinate_object_points+'" size="1">';
                        formArr += "<br>";
                    }
                    
                    // area
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_area == undefined) $.coordinate_object_area = "";
                        formArr +=  'Area <input type="text" name="area" class="area" data-type="text" data-json-name="area" value="'+$.coordinate_object_area+'" size="1">';
                        formArr += "<br>";
                    }
                    
                    // perimeter
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_perimeter == undefined) $.coordinate_object_perimeter = "";
                        formArr +=  'Perimeter <input type="text" name="perimeter" class="perimeter" data-type="text" data-json-name="perimeter" value="'+$.coordinate_object_perimeter+'" size="1">';
                        formArr += "<br>";
                    }

                    // coordinate_object_type
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps11" || JSONObject.template == "ps09" || JSONObject.template == "ps54" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26"  || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59" || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        formArr +=   'Coordinate Object Data Type ';
                        formArr +=   '<select name="coordinate_object_type" class="coordinate_object_type" data-type="select" data-json-name="coordinate_object_type">';
                        switch(JSONObject.template) {
                            case "ps08":
                            case "ps54":
			case "ps35":
			case "ps25":
			...
			case "ps56":
			case "ps510": 	
                                if($.coordinate_object_type == undefined) $.coordinate_object_type = 'Point';
                                if ( $.coordinate_object_type == 'Point') { formArr += '<option value="Point" selected>Points</option>'; } else { formArr += '<option value="Point">Points</option>'; }
                                if ( $.coordinate_object_type == 'Line') { formArr += '<option value="Line" selected>Lines</option>'; } else { formArr += '<option value="Line">Lines</option>'; }
                                break;
                            case "ps09":
							 case "ps26":
                                if($.coordinate_object_type == undefined) $.coordinate_object_type = 'Point';
                                if ( $.coordinate_object_type == 'Point') { formArr += '<option value="Point" selected>Points</option>'; } else { formArr += '<option value="Point">Points</option>'; }
                                if ( $.coordinate_object_type == 'Line') { formArr += '<option value="Line" selected>Lines</option>'; } else { formArr += '<option value="Line">Lines</option>'; }
                                if ( $.coordinate_object_type == 'Segment') { formArr += '<option value="Segment" selected>Special Functions</option>'; } else { formArr += '<option value="Segment">Special Functions</option>'; }
                                break;
                            case "ps11":
                                if($.coordinate_object_type == undefined) $.coordinate_object_type = 'Shape';
                                if ( $.coordinate_object_type == 'Shape') { formArr += '<option value="Shape" selected>Shape</option>'; } else { formArr += '<option value="Shape">Shape</option>'; }
                                if ( $.coordinate_object_type == 'Equation') { formArr += '<option value="Equation" selected>Equation</option>'; } else { formArr += '<option value="Equation">Equation</option>'; }
                                break;
                        }
                        formArr += '</select><br>';
                    }
                    ...
                    // equation_type
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_equation_type == undefined) $.coordinate_object_equation_type = 'Linear';
                        formArr +=   'Equation Type <select name="equation_type" class="equation_type" data-type="select" data-json-name="equation_type">';
                        if ( $.coordinate_object_equation_type == 'Linear') { formArr += '<option value="Linear" selected>Linear</option>'; } else { formArr += '<option value="Linear">Linear</option>'; }
                        if ( $.coordinate_object_equation_type == 'AbsoluteValue') { formArr += '<option value="AbsoluteValue" selected>Absolute Value</option>'; } else { formArr += '<option value="AbsoluteValue">Absolute Value</option>'; }
                        if ( $.coordinate_object_equation_type == 'Quadratic') { formArr += '<option value="Quadratic" selected>Quadratic</option>'; } else { formArr += '<option value="Quadratic">Quadratic</option>'; }
                        if ( $.coordinate_object_equation_type == 'SquareRoot') { formArr += '<option value="SquareRoot" selected>Square Root</option>'; } else { formArr += '<option value="SquareRoot">Square Root</option>'; }
                        if ( $.coordinate_object_equation_type == 'Cubic') { formArr += '<option value="Cubic" selected>Cubic</option>'; } else { formArr += '<option value="Cubic">Cubic</option>'; }
                        if ( $.coordinate_object_equation_type == 'CubeRoot') { formArr += '<option value="CubeRoot" selected>Cube Root</option>'; } else { formArr += '<option value="CubeRoot">Cube Root</option>'; }
                        if ( $.coordinate_object_equation_type == 'Exponential') { formArr += '<option value="Exponential" selected>Exponential</option>'; } else { formArr += '<option value="Exponential">Exponential</option>'; }
                        // if ( $.coordinate_object_equation_type == 'Logarithmic') { formArr += '<option value="Logarithmic" selected>Logarithmic</option>'; } else { formArr += '<option value="Logarithmic">Logarithmic</option>'; }
                        formArr +=      '</select>';
                        formArr +=      '<br>';
                    }
                    ...
                    // a constant
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_a == undefined) $.coordinate_object_a = "";
                        formArr += 'a <input type="text" name="a" class="a" data-type="text" data-json-name="a" value="'+$.coordinate_object_a+'" size="1">&nbsp;&nbsp;&nbsp;&nbsp;';
                    }
                    // b constant
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_b == undefined) $.coordinate_object_b = "";
                        formArr += 'b <input type="text" name="b" class="b" data-type="text" data-json-name="b" value="'+$.coordinate_object_b+'" size="1">&nbsp;&nbsp;&nbsp;&nbsp;';
                    }
                    // c constant
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_c == undefined) $.coordinate_object_c = "";
                        formArr += 'c <input type="text" name="c" class="c" data-type="text" data-json-name="c" value="'+$.coordinate_object_c+'" size="1">';
                        formArr += "<br>";
                    }

                    // coordinate_object_square
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_square == undefined) $.coordinate_object_square = 'true';
                        if ( $.coordinate_object_square == 'true' ) {
                            formArr +=  '<input type="checkbox" name="square" class="square" value="true" data-type="checkbox" data-json-name="square" checked> Square Shape';
                        } else {
                            formArr +=  '<input type="checkbox" name="square" class="square" value="false" data-type="checkbox" data-json-name="square"> Square Shape';
                        }
                        formArr +=      '<br>';
                    }

                    // coordinate_object_rectangle
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_rectangle == undefined) $.coordinate_object_rectangle = 'true';
                        if ( $.coordinate_object_rectangle == 'true' ) {
                            formArr +=  '<input type="checkbox" name="rectangle" class="rectangle" value="true" data-type="checkbox" data-json-name="rectangle" checked> Rectangle Shape';
                        } else {
                            formArr +=  '<input type="checkbox" name="rectangle" class="rectangle" value="false" data-type="checkbox" data-json-name="rectangle"> Rectangle Shape';
                        }
                        formArr +=      '<br>';
                    }

                    // coordinate_object_triangle
                    if(JSONObject.template === "ps10" || JSONObject.template === "ps210") {
                        if($.coordinate_object_triangle == undefined) $.coordinate_object_triangle = 'true';
                        if ( $.coordinate_object_triangle == 'true' ) {
                            formArr +=  '<input type="checkbox" name="triangle" class="triangle" value="true" data-type="checkbox" data-json-name="triangle" checked> Triangle Shape';
                        } else {
                            formArr +=  '<input type="checkbox" name="triangle" class="triangle" value="false" data-type="checkbox" data-json-name="triangle"> Triangle Shape';
                        }
                        formArr +=      '<br>';
                    }

                    // coordinate_object_connect
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps09" || JSONObject.template === "ps54" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26"  || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59"  || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        if($.coordinate_object_connect == undefined) $.coordinate_object_connect = 'true';
                        if ( $.coordinate_object_connect == 'true' ) {
                            formArr +=  '<input type="checkbox" name="connect" class="connect" value="true" data-type="checkbox" data-json-name="connect" checked> Display Connect Mode';
                        } else {
                            formArr +=  '<input type="checkbox" name="connect" class="connect" value="false" data-type="checkbox" data-json-name="connect"> Display Connect Mode';
                        }
                        formArr +=      '&nbsp;&nbsp;&nbsp;&nbsp;';
                    }

                    // coordinate_object_color_mode
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps09" || JSONObject.template === "ps54" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26"  || JSONObject.template === "ps57" || JSONObject.template === "ps55" || JSONObject.template === "ps58" || JSONObject.template === "ps59"  || JSONObject.template === "ps510" || JSONObject.template === "ps56") {
                        if($.coordinate_object_color_mode == undefined) $.coordinate_object_color_mode = 'true';
                        if ( $.coordinate_object_color_mode == 'true' ) {
                            formArr +=  '<input type="checkbox" name="colorMode" class="colorMode" value="true" data-type="checkbox" data-json-name="colorMode" checked> Color Mode';
                        } else {
                            formArr +=  '<input type="checkbox" name="colorMode" class="colorMode" value="false" data-type="checkbox" data-json-name="colorMode"> Color Mode';
                        }
                        formArr +=      '<br>';
                    }
				
				    // coordinate_object_data
                    if($.coordinate_object_data == undefined) $.coordinate_object_data = "";
					formArr +=  'Coordinate Object Data <input type="text" name="coordinate_object_data" class="" data-type="text" data-json-name="coordinate_object_data" value="'+$.coordinate_object_data+'" size="30">&nbsp;&nbsp;&nbsp;&nbsp;';

                    // coordinate_object_open
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps09" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26" || JSONObject.template === "ps54"  || JSONObject.template === "ps55") {
                        if($.coordinate_object_open == undefined) $.coordinate_object_open = 'true';
                        if ( $.coordinate_object_open == 'true' ) {
                            formArr +=  '<input type="checkbox" name="object_data_open" class="object_data_open" value="true" data-type="checkbox" data-json-name="object_data_open" checked> Unfinished Line';
                        } else {
                            formArr +=  '<input type="checkbox" name="object_data_open" class="object_data_open" value="false" data-type="checkbox" data-json-name="object_data_open"> Unfinished Line';
                        }
                    }
                    // coordinate_object_ghosted
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_ghosted == undefined) $.coordinate_object_ghosted = 'true';
                        if ( $.coordinate_object_ghosted == 'true' ) {
                            formArr +=  '<input type="checkbox" name="ghosted" class="ghosted" value="true" data-type="checkbox" data-json-name="ghosted" checked> Ghosted Original';
                        } else {
                            formArr +=  '<input type="checkbox" name="ghosted" class="ghosted" value="false" data-type="checkbox" data-json-name="ghosted"> Ghosted Original';
                        }
                    }
                    formArr += '<br>';
                    ...
                    // reference_labels
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_reference_labels == undefined) $.coordinate_object_reference_labels = "";
                        formArr +=  'Coordinate Object Data Labels <input type="text" name="reference_labels" class="" data-type="text" data-json-name="reference_labels" value="'+$.coordinate_object_reference_labels+'" size="30"><br>';
                    }

                    // coordinate_object_answer
                    if($.coordinate_object_answer == undefined) $.coordinate_object_answer = "";
                    formArr +=  'Coordinate Object Answer <input type="text" name="coordinate_object_answer" class="" data-type="text" data-json-name="coordinate_object_answer" value="'+$.coordinate_object_answer+'" size="30"><br>';
                    
                    // coordinate_object_inequalities
                    if(JSONObject.template === "ps09" || JSONObject.template === "ps26") {
                        if($.coordinate_object_inequalities == undefined) $.coordinate_object_inequalities = 'true';
                        if ( $.coordinate_object_inequalities == 'true' ) {
                            formArr +=  '<input type="checkbox" name="inequalities" class="inequalities" value="true" data-type="checkbox" data-json-name="inequalities" checked> System of Inequalities &nbsp;&nbsp;&nbsp;&nbsp;';
                        } else {
                            formArr +=  '<input type="checkbox" name="inequalities" class="inequalities" value="false" data-type="checkbox" data-json-name="inequalities"> System of Inequalities &nbsp;&nbsp;&nbsp;&nbsp;';
                        }
                    }
                    // coordinate_object_no_solution
                    if(JSONObject.template === "ps09" || JSONObject.template === "ps26") {
                        if($.coordinate_object_no_solution == undefined) $.coordinate_object_no_solution = 'true';
                        if ( $.coordinate_object_no_solution == 'true' ) {
                            formArr +=  '<input type="checkbox" name="no_solution" class="no_solution" value="true" data-type="checkbox" data-json-name="no_solution" checked> No Solution';
                        } else {
                            formArr +=  '<input type="checkbox" name="no_solution" class="no_solution" value="false" data-type="checkbox" data-json-name="no_solution"> No Solution';
                        }
                    }
                    formArr += '<br>';

                    // coordinate_object_slope
                    if(JSONObject.template === "ps08" || JSONObject.template === "ps09" || JSONObject.template === "ps35" || JSONObject.template === "ps25" || JSONObject.template === "ps26" || JSONObject.template === "ps55") {
                        if($.coordinate_object_slope == undefined) $.coordinate_object_slope = "";
                        formArr +=  'Answer Slope <input type="text" name="slope" class="" data-type="text" data-json-name="slope" value="'+$.coordinate_object_slope+'" size="30"><br>';
                    }

                    // rotation_point
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_rotation_point == undefined) $.coordinate_object_rotation_point = "";
                        formArr += 'Rotation Point <input type="text" name="rotation_point" class="rotation_point" data-type="text" data-json-name="rotation_point" value="'+$.coordinate_object_rotation_point+'" size="10"> <span class="small">( accepts ordered pair or keyword <strong>default</strong> )</span>';
                        formArr += "<br>";
                    }
                    
                    // coordinate_object_show_flip_horz_btn
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_show_flip_horz_btn == undefined) $.coordinate_object_show_flip_horz_btn = 'true';
                        if ( $.coordinate_object_show_flip_horz_btn == 'true' ) {
                            formArr +=  '<input type="checkbox" name="show_flip_horz_btn" class="show_flip_horz_btn" value="true" data-type="checkbox" data-json-name="show_flip_horz_btn" checked> Show \'Flip Horizontal\' Button';
                        } else {
                            formArr +=  '<input type="checkbox" name="show_flip_horz_btn" class="show_flip_horz_btn" value="false" data-type="checkbox" data-json-name="show_flip_horz_btn"> Show \'Flip Horizontal\' Button';
                        }
                        formArr += "<br>";
                    }

                    // coordinate_object_show_flip_vert_btn
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_show_flip_vert_btn == undefined) $.coordinate_object_show_flip_vert_btn = 'true';
                        if ( $.coordinate_object_show_flip_vert_btn == 'true' ) {
                            formArr +=  '<input type="checkbox" name="show_flip_vert_btn" class="show_flip_vert_btn" value="true" data-type="checkbox" data-json-name="show_flip_vert_btn" checked> Show \'Flip Vertical\' Button';
                        } else {
                            formArr +=  '<input type="checkbox" name="show_flip_vert_btn" class="show_flip_vert_btn" value="false" data-type="checkbox" data-json-name="show_flip_vert_btn"> Show \'Flip Vertical\' Button';
                        }
                        formArr += "<br>";
                    }

                    // coordinate_object_show_rotate_btn
                    if(JSONObject.template === "ps11") {
                        if($.coordinate_object_show_rotate_btn == undefined) $.coordinate_object_show_rotate_btn = 'true';
                        if ( $.coordinate_object_show_rotate_btn == 'true' ) {
                            formArr +=  '<input type="checkbox" name="show_rotate_btn" class="show_rotate_btn" value="true" data-type="checkbox" data-json-name="show_rotate_btn" checked> Show \'Rotate\' Button';
                        } else {
                            formArr +=  '<input type="checkbox" name="show_rotate_btn" class="show_rotate_btn" value="false" data-type="checkbox" data-json-name="show_rotate_btn"> Show \'Rotate\' Button';
                        }
                        formArr += "<br>";
                    }

                    // coordinate_object_line_option
                    if(JSONObject.template === "ps09" || JSONObject.template === "ps26") {
                        if($.coordinate_object_line_option == undefined) $.coordinate_object_line_option = 'true';
                        if ( $.coordinate_object_line_option == 'true' ) {
                            formArr +=  '<input type="checkbox" name="lineOption" class="lineOption" value="true" data-type="checkbox" data-json-name="lineOption" checked> Show \'Line Type\' Button';
                        } else {
                            formArr +=  '<input type="checkbox" name="lineOption" class="lineOption" value="false" data-type="checkbox" data-json-name="lineOption"> Show \'Line Type\' Button';
                        }
                        formArr += "<br>";
                    }

                    // coordinate_object_shade_option
                    if(JSONObject.template === "ps09" || JSONObject.template === "ps26") {
                        if($.coordinate_object_shade_option == undefined) $.coordinate_object_shade_option = 'true';
                        if ( $.coordinate_object_shade_option == 'true' ) {
                            formArr +=  '<input type="checkbox" name="shadeOption" class="shadeOption" value="true" data-type="checkbox" data-json-name="shadeOption" checked> Show \'Shade\' Button';
                        } else {
                            formArr +=  '<input type="checkbox" name="shadeOption" class="shadeOption" value="false" data-type="checkbox" data-json-name="shadeOption"> Show \'Shade\' Button';
                        }
                        formArr += "<br>";
                    }

                    // coordinate_object_arrow_option
                    if(JSONObject.template === "ps09" || JSONObject.template === "ps26") {
                        if($.coordinate_object_arrow_option == undefined) $.coordinate_object_arrow_option = 'true';
                        if ( $.coordinate_object_arrow_option == 'true' ) {
                            formArr +=  '<input type="checkbox" name="arrowOption" class="arrowOption" value="true" data-type="checkbox" data-json-name="arrowOption" checked> Show \'Arrow\' Button';
                        } else {
                            formArr +=  '<input type="checkbox" name="arrowOption" class="arrowOption" value="false" data-type="checkbox" data-json-name="arrowOption"> Show \'Arrow\' Button';
                        }
                        formArr += "<br>";
                    }

				formArr += '<span class="small note">code = ##</span>'; 
				
	            formArr +=  '</div>';
	            formArr +=  '<!-- END coordinate_object Block -->';  
...
if ( typeof JSONObject.coordinate_object1 !== 'undefined' ) {
                ...
                formArr += '<!-- Coordinate Object Block -->';
                formArr +=  '<div id="coordinate_object1" class="block">';

                //formArr +=      '<strong>Coordinate Object:</strong>';
               
				
                // Move Object Data 
                $.each(JSONObject.coordinate_object1, function(index) { 
					formArr +=      '<strong>Coordinate Object:</strong>';
                    // all
                    $.coordinate_object_answer = this.coordinate_object_answer;
                    $.coordinate_object_data = this.coordinate_object_data;
	                ...
	                formArr +=  '<div class="in_block" data-name="coordinate_object1" data-id="'+index+'">';
                	
                    // number of quadrants
					if(JSONObject.template === "ps55" || JSONObject.template === "ps56") {
                        if ($.coordinate_object_quadrants == undefined ) $.coordinate_object_quadrants = '1';
    	                formArr +=   'Quadrants <select name="quadrants" class="quadrants" data-type="select" data-json-name="quadrants">';
    	                if ( $.coordinate_object_quadrants == '1') { formArr += '<option value="1" selected>1</option>'; } else { formArr += '<option value="1">1</option>'; }
    	                if ( $.coordinate_object_quadrants == '4') { formArr += '<option value="4" selected>4</option>'; } else { formArr += '<option value="4">4</option>'; }
				    ...
				    // coordinate_object_data
                    if($.coordinate_object_data == undefined) $.coordinate_object_data = "";
					formArr +=  'Coordinate Object Data <input type="text" name="coordinate_object_data1" class="" data-type="text" data-json-name="coordinate_object_data1" value="'+$.coordinate_object_data+'" size="30">&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            //console_on && console.log(JSON.stringify(JSONObject, null, '\t'));
            $(".colorPicker").spectrum({
                change: function(color) { console_on && console.log(this);},
                showInput: true,
                showInitial: true,
                preferredFormat: "hex",
            ...
            //zzzz make this a function pass in peramiters - Fixed PaulS
             $(".add_block").on("click",function(event) {
                ...
                console_on && console.log(name);
                $.count = $('.in_block[data-name="'+name+'"]').length;
                console_on && console.log($.count);
            ...
            // specific listeners for certain templates
            switch(JSONObject.template) {
                case "ps09":
				 case "ps26":
                    // get coordinte object type selects
                    var obTypes = $("#coordinate_object select[name=coordinate_object_type]");

                    // cycle through them
                    for (var i = 0; i < obTypes.length; i++) {
                        var id =  $(obTypes[i]).parent().data('id');
                        var lineOpt = $("#coordinate_object > div[data-id="+id+"] input[name=lineOption]").removeClass('disabled');
                        var shadeOpt = $("#coordinate_object > div[data-id="+id+"] input[name=shadeOption]").removeClass('disabled');
                        var arrowOpt = $("#coordinate_object > div[data-id="+id+"] input[name=arrowOption]").removeClass('disabled');
                        var ineqOpt = $("#coordinate_object > div[data-id="+id+"] input[name=inequalities]").removeClass('disabled');
                        var connect = $("#coordinate_object > div[data-id="+id+"] input[name=connect]").removeClass('disabled');
                        var unfinBtn = $("#coordinate_object > div[data-id="+id+"] input[name=object_data_open]").removeClass('disabled');
                        var colorBtn = $("#coordinate_object > div[data-id="+id+"] input[name=colorMode]").removeClass('disabled');
                        switch($(obTypes[i]).val()) {
                            case "Point":
                                lineOpt.addClass('disabled');
                                shadeOpt.addClass('disabled');
                                arrowOpt.addClass('disabled');
                                ineqOpt.addClass('disabled');
                                break;
                            case "Line":
                                arrowOpt.addClass('disabled');
                                connect.addClass('disabled');
                                unfinBtn.addClass('disabled');
                                colorBtn.addClass('disabled');
                                break;
                            case "Segment":
                                lineOpt.addClass('disabled');
                                shadeOpt.addClass('disabled');
                        ...
                        lineOpt.prop('disabled', lineOpt.hasClass('disabled'));
                        shadeOpt.prop('disabled', shadeOpt.hasClass('disabled'));
                        arrowOpt.prop('disabled', arrowOpt.hasClass('disabled'));
                        ineqOpt.prop('disabled', ineqOpt.hasClass('disabled'));
                        connect.prop('disabled', connect.hasClass('disabled'));
                        unfinBtn.prop('disabled', unfinBtn.hasClass('disabled'));
                        colorBtn.prop('disabled', colorBtn.hasClass('disabled'));

                        // apply listener
                        $(obTypes[i]).on("change", function(){
                ...
                case "ps11":
                    ...
                    for (var i = 0; i < obTypes.length; i++) {
                        var id =  $(obTypes[i]).parent().data('id');
                        var eqType = $("#coordinate_object > div[data-id="+id+"] select[name=equation_type]");
                        if ($(obTypes[i]).val() === "Equation") {
                            eqType.removeClass('disabled');
                        } else {
                            eqType.addClass('disabled');
                        }
                        eqType.prop('disabled', eqType.hasClass('disabled'));
        ...
        build_keypad_events: function( e ) {
            ...
            if ( typeof JSONObject.type_object !== 'undefined' ) {
                $.each(JSONObject.type_object, function(index) { 
                    ...
                    $('#type_object_form_'+index+'').on("mousedown", function(e){clickedTextField($(this)[0].id)});
                }); 
            }
        ...
        keypad_obj_change: function( event ) {
            ...
            console_on && console.log('keypad_obj_change');
            ...
            //console_on && console.log( field_value + ' | ' +  field_name + ' | ' + field_parent_id );
            // 1 | type | 0 
        ...
        store_keypad: function(keypad) {
            ...
            console_on && console.log('store_keypad');
        ...
        fileupload: function ( event ) { 
            ...
            console_on && console.log('fileupload');
        ...
        remove_audio: function ( event ) { 
            ...
            console_on && console.log('remove_audio');
        ...
        show_hide_type: function ( type ) { 
            ...
            console_on && console.log('show_hide_type');
        ...
        textarea_br: function ( event ) { 
            ...
            console_on && console.log('textarea_br');
        ...
        textarea_nospace: function ( event ) { 
            ...
            console_on && console.log('textarea_nospace');
        ...
        updateJSON: function ( event ) {
            ...
            console_on && console.log('updateJSON');
            ...
            $(":input").on("keyup change", function(e) {
                ...
                case 'select':
                  //
                    ...
                    if ( field_name == 'marker' || field_name == 'attempts' || field_name == 'grades' ) {
                        ...
                        JSONObject[field_parent][field_parent_id][field_name] = field_value;    
                        // console_on && console.log( 'write:' + field_parent + ' | ' +  field_parent_id + ' | ' + field_name + ' | ' + field_value + ' | ' + field_type );                           
                ...
                case 'checkbox':                  
                  ...
                  if(e.type == "change" && (field_parent == "answer" || field_parent == "answer1")){
                    if(JSONObject.single && field_parent == "answer"){
                        $("#answer input[type=checkbox]").attr('checked', false);
                        $(this).attr('checked', true);
                    }
                    if(JSONObject.single && field_parent == "answer1"){
                        $("#answer1 input[type=checkbox]").attr('checked', false);
                        $(this).attr('checked', true);
                    }
                  }
				 if (e.type == "change" && (template == 'ps20' || template == 'ps22' || template == 'ps32') && field_name == 'single') {
					$(this).is(':checked')? JSONObject[field_name] = true : JSONObject[field_name] = false;
                    $("#answer input[type=checkbox]").attr('checked', false);
                    $("#answer1 input[type=checkbox]").attr('checked', false);
                 } else if(e.type == "change") {
                  $('.in_block[data-name="'+field_parent+'"].in_block[data-id="'+field_parent_id+'"] .' + field_name ).is(':checked') ?
                         JSONObject[field_parent][field_parent_id][field_name] = 'true' : JSONObject[field_parent][field_parent_id][field_name] = 'false';                       
                ...
                case 'shadows':
                case 'use_keypad':
                    var isChecked = $("[data-type="+field_type+"]").is(":checked");
                    if (JSONObject[field_type] == 'true' && !isChecked) {
                        JSONObject[field_type] = 'false';
                        if (field_type == "use_keypad") {
                            $.each(JSONObject.type_object, function(i) {
                                JSONObject.type_object[i].source = "";
                                JSONObject.type_object[i].output = "";
                            });
                            JSONObject["shadows"] = "false";
                        }
                        LO_page_app.formBuilder();          
                    } else if ( JSONObject[field_type] == 'false' && isChecked) {
                        JSONObject[field_type] = 'true';
                        if (field_type == "use_keypad") {
                            $.each(JSONObject.type_object, function(i) {
                                JSONObject.type_object[i].source = "";
                                JSONObject.type_object[i].output = "";
            ...
            $('#zip_this').click(function(e){
                e.preventDefault();
                form = $('#zip_form');
                form.submit();
            });
            $('#zip_all').click(function(e){
                e.preventDefault();
                form = $('#zip_form_all');
                form.submit();
            });
        ...
        auto_check: function ( event ) {
            ...
            console_on && console.log('auto_check');
...
// Not part of Template Page Builder            
            ...
            console_on && console.log('pageEditor');
                        
            var position = '';
            if ( mode == 'edit' ) {
                                
                $.dragoptions = { 
                    stack: ".numberline_object .content .title, .content .content_box, .content .move_object, .content .drop_object, .content .drag_object, .content .question, .content .answer",
                ...
                $( ".content .title, .content .content_box, .content .move_object, .content .drop_object, .content .drag_object, .content .question, .content .answer, .content .shading_object, .content .numberline_object, .content .coordinate_object, .play_button, .tooltip, .cover" ).draggable($.dragoptions).prepend('<div class="handle"><img src="images/handle.png"> <span class="readout"><span class="top"></span><span class="left"></span></span></div>');
        ...
        formScreenDown: function( event ) {
            ...
            console_on && console.log('formScreenDown');
        ...
        formScreenUp: function( event ) {
            ...
            console_on && console.log('formScreenUp');
        ...
        readFeedbackJSON: function( data ) {
            ...
            console_on && console.log('readFeedbackJSON');
        ...
        readLinksJSON: function( data ) {
            ...
            console_on && console.log('readLinksJSON',data);
            linksObject = data;
        ...
        build_feedback_cycles: function( feedback_group, sound_name ) {
            ...
            console_on && console.log('build_feedback_cycles');
