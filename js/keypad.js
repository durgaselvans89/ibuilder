		...
		for (var i = 0; i < tMasterLen; i++){
			...
			tString = _masterHtmlArray[i];
				...
				if (tString.indexOf(FRACTION_DELIMITER) !== -1){
					...
					var tNewString  = "&#92;" + "(" + "&#92;" + "frac{"+ "&#92;" +"style{font-family:mheelemsanscondensed, Arial, sans-serif;}{"+ "&#92;" +"text{" + tTop +"}}}{"+"&#92;"+ "style{font-family:mheelemsanscondensed, Arial, sans-serif;}{"+ "&#92;" +"text{"+ tBot + "}}}"+ "&#92;" + ")"
				     var tNewString  =  "\\(\\frac{\\style{font-family:mheelemsanscondensed, Arial, sans-serif;}{\\text{" + tTop +"}}}{\\style{font-family:mheelemsanscondensed, Arial, sans-serif;}{\\text{"+ tBot + "}}}\\)"
