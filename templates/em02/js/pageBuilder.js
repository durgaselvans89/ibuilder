		...
		contentArr += '<div id="answer_set" class="answers" data-id="0">';
			...
			$.each(JSONObject.answer, function(index) { 
				...
				if ( $.json_answer_top !== 'default' ) {
					$.position = 'top: '+$.json_answer_top+'px; left: '+$.json_answer_left+'px; position: absolute; ';
				} else { $.position = ''; }
				
				if ( $.json_answer_width !== 'default' && $.json_answer_width !== '' ) {
					$.add_json_width = 'width: '+$.json_answer_width+'px; height: auto;';
				} else { $.add_json_width = 'width: auto'; }
				...
				if ( $.json_answer_type == 'txt') {
					contentArr += '<div id="answer_'+index+'" style="'+$.position+$.add_json_width+'"  class="answer" data-block="answer" data-id="'+$.json_answer_id+'" data-correct="'+$.json_answer_correct+'" data-type="'+$.json_answer_type+'" data-name="'+$.json_answer_name +'" data-marker="'+$.json_marker+'" data-protocol=""><span class="txt">' + $.json_answer_txt + '</span><span class="marker"><span class="markerValue">'+$.markerValue+'</span><span class="markerHTML">'+markerHTML+'</span></span></div>';					
				} else {
					contentArr += '<div id="answer_'+index+'" style="'+$.position+$.add_json_width+'"  class="answer" data-block="answer" data-id="'+$.json_answer_id+'" data-correct="'+$.json_answer_correct+'" data-type="'+$.json_answer_type+'" data-name="'+$.json_answer_name +'" data-marker="'+$.json_marker+'" data-protocol=""><img src="'+media_path+'/images/'+$.json_answer_name+'" class="content_img"><br><span class="marker center"><span class="markerValue">'+$.markerValue+'</span><span class="markerHTML">'+markerHTML+'</span></span></div>';					
				}
