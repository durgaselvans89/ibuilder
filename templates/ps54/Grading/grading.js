function GradeCogneroQuestion(stateObj, pointsPossible) {
	...
	typeCrr = (typeCrr == stateObj.typeData.length) ? 1  : 0;	

	//var pointsEarned = ((pointsPossible * percentEarned)+(typeCrr* pointsPossible))/2;
	var pointsEarned = (percentEarned ==1 && typeCrr==1) ?  1 : 0;	
	return pointsEarned;
}
/*function GradeCogneroQuestion(stateObj, pointsPossible) {
	var percentEarned = 0;
