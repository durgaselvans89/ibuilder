...
function hidekeyboardAndLayer2(){
    ...
    if(ps54.currentlyOpen != null) {
        ps54.hideInput(ps54.currentlyOpen);
    }
...
function loadKeyPads(ps03) {
    _keyPads = {};
    _keyPads["1"] = new keyPad().init("numeric_keypad_G1to6",
         function(){hidekeyboardAndLayer2();},playClickSFX,playNegSFX, true, 3,"1","123s");
    _keyPads["2"] = new keyPad().init("math_keypad_G1to2",
         function(){hidekeyboardAndLayer2();}, playClickSFX,playNegSFX, true, 3,"2","123s");
    _keyPads["3"] = new keyPad().init("full_keypad_g1to2",
         function(){hidekeyboardAndLayer2();}, playClickSFX,playNegSFX, true, 3,"3","123s");
    _keyPads["4"] = new keyPad().init("ela_full_keypad_g1to2",
         function(){hidekeyboardAndLayer2();}, playClickSFX,playNegSFX, true, 3,"4","abcs");
}
