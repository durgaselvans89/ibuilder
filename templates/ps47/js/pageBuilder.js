...
var isBuilderPHP = false;
    ...
    if (!isBuilderPHP && media_path !== undefined) {
    	isTemplate = true;
	    	$.getScript("js/ps47.js");
	    	$.getScript("Grading/grading.js");
        } else if (media_path !== "") {
	    	$.getScript("templates/ps47/js/rgbcolor.js");
	    	$.getScript("templates/ps47/js/StackBlur.js");
	    	$.getScript("templates/ps47/js/canvg.js");
	    	$.getScript("templates/ps47/js/lib/html2canvas.js");
	    	$.getScript("templates/ps47/js/ps47.js");
	    	$.getScript("templates/ps47/Grading/grading.js");
        }
        polljQuery(30);
...
function polljQuery (time) {
  if (window.jQuery && $(".numberline_object").length == JSONObject.numberline_object.length && window.ps47 && window.canvg && window.html2canvas && window.MathJax) {
