...
var page_builder_app = {
	...
	// END new content wrapper
        ...
        if (pageName[1] !== "builder.php" && media_path !== "") {
	    	$.getScript("js/ps05.js");
	    	$.getScript("Grading/grading.js");
        } else if (media_path !== "") {
	    	$.getScript("templates/ps05/js/rgbcolor.js");
	    	$.getScript("templates/ps05/js/StackBlur.js");
	    	$.getScript("templates/ps05/js/canvg.js");
	    	$.getScript("templates/ps05/js/lib/html2canvas.js");
	    	$.getScript("templates/ps05/js/ps05.js");
	    	$.getScript("templates/ps05/Grading/grading.js");
        }
        polljQuery(30);
...
function polljQuery (time) {
  if (window.jQuery && $(".numberline_object").length == JSONObject.numberline_object.length && window.ps05 && window.canvg && window.html2canvas && window.MathJax) {
