...
/* 
  ===================================================================
  EM MOVABLE OBJECT TEMPLATE  em08 CONTROLLER
...
var AppController = {
		...
		startController: function(){
			...
			$("#lockout").css({"position":"absolute","background": "white", "width": "1000px","height":"570px","top":"0px","left":"0px","z-index":1000});
			//return;
			...
			dispatcher.bind("iteration.gamestate.em01", function(p_state){
				...
				if ((p_state.type === "iteration")&&(p_state.status === "new")){
					...
					LO_app = new movableObjectsTemplate().init(	AppController.myDispatcher, window.dispatcher);
