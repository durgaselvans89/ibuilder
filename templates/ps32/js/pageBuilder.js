		...
		contentArr += '<div id="content_box_set" class="content_boxs" data-id="0">';
			...
			$.each(JSONObject.content_box1, function(index) { 
				...
				case 'txt':
				  ...
				  break;
				case 'img':
				  contentArr += '<div id="content_box_'+$.json_content_box_id+'" style="'+$.position+'" class="content_box" data-block="content_box1" data-id="'+$.json_content_box_id+'" data-type="'+$.json_content_box_type+'" data-name="'+$.json_content_box_name+'"><img src="'+image_path+$.json_content_box_name+'" style="'+$.add_json_width+'" class="content_img"><div class="print_width"></div></div>';
				  break;
				case 'hide':
				  contentArr += '';
				  break;
...
function polljQuery (time) {
  if (window.jQuery && $(".drop_object").length > 0 && window.ps32) {
