...
var page_builder_app = {
	...
	pageBuilder: function(event) {
		console.log("ps57 pageBuild.pageBuilder --- ");
    ...
    polljQuery(30, isTemplate);
		...
		// 	ps57.init(JSONObject);
		// }
	},
	numberlines: [],
    load_numberlines: function() {
        var cogAPI = false;console.log('load_numberlines')
        ...
        $("#controls").remove();console.log('load_numberlines 796'+pageName[2])
        if (pageName[2] === 'builder.php' && $(".edit_mode")[0].value === "edit") {
...
function withjQuery (isTemplate) {
    ps57.init(JSONObject, isTemplate);
...
function polljQuery (time, isTemplate) {
  if (window.jQuery && $(".content_boxs").length > 0 && window.ps57) {
